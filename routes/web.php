...
Route::get('/admin/citas/agregar_cita/select_horario/{id}', [AdminController::class, 'select_horario_atencion_agregar_cita'])->name('admin.select_horario_atencion_agregar_cita');

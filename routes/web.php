...
Route::get('/medico/{id}/citas', MedicosController::class . '@index_citas')->name('medico.index_citas');
Route::put('/medico/{id_medico}/citas/{id}/cancelar', MedicosController::class . '@cancelar_cita')->name('medico.cancelar_cita');

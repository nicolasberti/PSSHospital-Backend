...
<div class="card shadow">
    <form action="/admin/guardar-datos-criticos-paciente/{{$solicitud->paciente->id}}" method="POST" class="container px-4 py-3">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-md-4">
        ...
        <button type="submit" class="btn btn-primary">Guardar</button>
            <a href="/admin/solicitudes" id="cancel" name="cancel" class="btn btn-danger">Cancelar</a>
    </form>
</div>
@endsection
